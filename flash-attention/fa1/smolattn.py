...
# Load CUDA kernel
smolattn = load(name='smolattn', sources=['build.cpp', 'flash-attn-1.cu'], extra_cuda_cflags=['-O3'])
...
print("\n=== Benchmarking SmolAttn Implementation ===")
minimal_result, smolattn_time = benchmark(smolattn.fa_forward, q, k, v, name="SmolAttn")

# Print speedup
speedup = manual_time / smolattn_time
print(f"\nSmolAttn is {speedup:.2f}x faster than Manual Attention.")
